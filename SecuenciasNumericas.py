...
class secuencias():
    ...
    """def evento_clic(self,ubicacion):
        ...
        #if(x_mouse > 451 and x_mouse <= 497) and (y_mouse > 613 and y_mouse < 630):
        if(x_mouse > 456 and x_mouse <= 504) and (y_mouse > 580 and y_mouse < 630) :   
            arrastre=1
            ubicacion.fill((255,255,255))
        ...
        elif (y_mouse > 456 or y_mouse < 504) or (x_mouse > 580 or x_mouse <= 630) and arrastre==1:
            ubicacion.blit(self.cuatro,(780,370))
            arrastre=0
            mostrar=1
            ubicacion.blit(self.nivel1,(0,0))
